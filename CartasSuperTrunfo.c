...
int main(void)
{
  ...
  setlocale(LC_NUMERIC, "C");
    ...
    scanf("%d", &pontosTuristicos1);
     ...
     pibPerCapita1 = (pib1 * 1000) / populacao1; // Convertendo PIB para milhões de reais e calculando per capita
    ...
    scanf("%d", &pontosTuristicos2);
     ...
     pibPerCapita2 = (pib2 * 1000) / populacao2; // Convertendo PIB para milhões de reais e calculando per capita
